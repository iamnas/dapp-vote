...
const StatusMessage = ({ success, message }: StatusMessageProps) => (
    <div className={`mt-3 p-2.5 rounded-md text-sm flex items-center gap-2 ${success
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                ...
                <div className={`${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} rounded-xl shadow-md p-5 sm:p-6 border`}>
                    <div className="flex items-center gap-2 mb-4 sm:mb-5">
                        ...
                        <h2 className={`text-xl font-semibold ${darkMode ? 'text-white' : 'text-gray-900'}`}>Add Candidate</h2>
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${darkMode ? 'bg-gray-700 text-white border-gray-600' : 'bg-gray-50 text-gray-900 border-gray-300'
                                }`}
                    ...
                    <button
                        ...
                        className={`w-full py-2.5 px-4 rounded-lg font-medium flex items-center justify-center gap-2 text-sm sm:text-base transition-colors ${isSubmitting || !name.trim()
                ...
                <div className={`${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} rounded-xl shadow-md p-5 sm:p-6 border`}>
                    <div className="flex items-center gap-2 mb-4 sm:mb-5">
                        ...
                        <h2 className={`text-xl font-semibold ${darkMode ? 'text-white' : 'text-gray-900'}`}>Register Voter</h2>
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 transition-colors ${voterFetched && isRegistered
                        ...
                        {voterAddress && voterAddress.startsWith("0x") && voterAddress.length === 42 && (
                            <div className={`mt-2 text-sm flex items-center gap-1.5 ${voterFetched && isRegistered
                    ...
                    <button
                        ...
                        className={`w-full py-2.5 px-4 rounded-lg font-medium flex items-center justify-center gap-2 text-sm sm:text-base transition-colors ${isRegistering || !voterAddress || !voterAddress.startsWith("0x") || voterAddress.length !== 42 || (voterFetched && isRegistered)
                            ? `${darkMode ? 'bg-gray-700 text-gray-400' : 'bg-gray-200 text-gray-500'} cursor-not-allowed`
                            : `${darkMode ? 'bg-blue-600 hover:bg-blue-700' : 'bg-blue-600 hover:bg-blue-700'} text-white`
                            }`}
                    >
